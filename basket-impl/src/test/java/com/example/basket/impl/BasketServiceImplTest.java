...
import com.example.tools.CompletionStageUtils;
        ...
        withServer(defaultSetup().withCassandra(true), server ->
                {
                    ...
                    CompletionStage<Done> basketSetup = CompletionStageUtils.doAll(
                            service.addItem(basketId).invoke(oranges),
                            service.addItem(basketId).invoke(apples),
